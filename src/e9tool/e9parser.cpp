...
static const TokenInfo tokens[] =
{
    ...
    {"file",            TOKEN_FILENAME,         0},
    {"filename",        TOKEN_FILENAME,         0},
    {"flags",           TOKEN_FLAGS,            0},
    ...
    {"rex",             TOKEN_REX,              0},
    {"rflags",          TOKEN_REGISTER,         REGISTER_RFLAGS},
